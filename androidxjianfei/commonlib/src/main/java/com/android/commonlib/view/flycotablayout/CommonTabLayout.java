package com.android.commonlib.view.flycotablayout;
...
import com.android.commonlib.view.flycotablayout.utils.FragmentChangeManager;
import com.android.commonlib.view.flycotablayout.utils.UnreadMsgUtils;
import com.android.commonlib.view.flycotablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    /**
     * 关联数据支持同时切换fragments 在Activity使用
     */
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments, int index) {
        mFragmentChangeManager = new FragmentChangeManager(fa.getSupportFragmentManager(), containerViewId, fragments, index);
    ...
    /**
     * 关联数据支持同时切换fragments 在Fragment使用
     */
    public void setTabDataFragment(ArrayList<CustomTabEntity> tabEntitys, Fragment fa, int containerViewId, ArrayList<Fragment> fragments, int index) {
        mFragmentChangeManager = new FragmentChangeManager(fa.getChildFragmentManager(), containerViewId, fragments, index);
        setTabData(tabEntitys);
    }
    public void setTabDataFragment(ArrayList<CustomTabEntity> tabEntitys, Fragment fa, int containerViewId, ArrayList<Fragment> fragments) {
        setTabDataFragment(tabEntitys, fa, containerViewId, fragments, 0);
    }
