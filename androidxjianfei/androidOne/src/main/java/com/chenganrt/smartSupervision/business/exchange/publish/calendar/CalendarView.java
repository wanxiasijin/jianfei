package com.chenganrt.smartSupervision.business.exchange.publish.calendar;
...
public class CalendarView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LinearLayout calendar = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.layout_calendar_bottom, null);
        addView(calendar);
        TextView cancel = calendar.findViewById(R.id.tv_cancel);
        TextView submit = calendar.findViewById(R.id.btn_submit);
        ...
        cancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnCancelSelectedListener != null) {
                    mOnCancelSelectedListener.onCancelSelected();
                }
            }
        });
