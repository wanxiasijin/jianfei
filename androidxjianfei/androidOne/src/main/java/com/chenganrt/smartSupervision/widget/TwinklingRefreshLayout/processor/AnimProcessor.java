package com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.processor;
...
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.TwinklingRefreshLayout;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.util.ScrollingUtil;
    ...
    public void animOverScrollTop(float vy, int computeTimes) {
        ...
        animLayoutByTime(getVisibleHeadHeight(), overHeight, time, overScrollTopUpListener, new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                animLayoutByTime(overHeight, 0, 2L * time, overScrollTopUpListener, new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        isOverScrollTopLocked = false;
                    }
        ...
        if (!scrollBottomLocked && cp.autoLoadMore()) {
            ...
            animLayoutByTime(0, overHeight, time, overScrollBottomUpListener, new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    animLayoutByTime(overHeight, 0, 2L * time, overScrollBottomUpListener, new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            isOverScrollBottomLocked = false;
                        }
