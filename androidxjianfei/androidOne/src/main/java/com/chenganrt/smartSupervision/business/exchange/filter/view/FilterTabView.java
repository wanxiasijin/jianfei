...
import com.chenganrt.smartSupervision.business.exchange.filter.view.listener.OnAdapterRefreshListener;
...
import com.chenganrt.smartSupervision.business.exchange.filter.view.listener.OnSelectFilterNameListener;
...
import com.chenganrt.smartSupervision.business.exchange.filter.view.util.Utils;
...
public class FilterTabView extends LinearLayout implements OnFilterToViewListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            colorMain = a.getColor(R.styleable.FilterTabView_color_main, mContext.getResources().getColor(R.color.green_theam2));
            btnStrokeSelect = a.getColor(R.styleable.FilterTabView_btn_stroke_select_color, mContext.getResources().getColor(R.color.green_theam2));
            ...
            btnTextSelect = a.getColor(R.styleable.FilterTabView_btn_text_select_color, mContext.getResources().getColor(R.color.green_theam2));
    ...
    public FilterTabView addFilterItem(String tabName, List<BaseFilterBean> data, final int filterType, int popupIndex) {
        ...
        basePopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                try {
                    ...
                    Timber.d("filterType:" + filterType);
                    Timber.d("position:" + position);

                    resetSelectData(position,filterType);

                    setArrowDirection(tv_tab_name, false);
                    if (position == 3 && onPopupDismissListener != null) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentIndex == 3 && onPopupDismissListener != null) {
                    onPopupDismissListener.onDismiss();
                } else {
                    //弹出当前页pop,或者回收pop
