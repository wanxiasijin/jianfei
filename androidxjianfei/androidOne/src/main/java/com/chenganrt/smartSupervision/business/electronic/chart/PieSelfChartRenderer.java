...
public class PieSelfChartRenderer extends DataRenderer {

    protected PiechartSelfView mChart;
    ...
    public PieSelfChartRenderer(PiechartSelfView chart, ChartAnimator animator,
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            //mValueLinePaint.setColor(Color.GRAY);
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    if (drawXOutside && drawYOutside) {
                        ...
                        drawValue(c, formatter, value, entry, 0, labelPtx, labelPty + lineHeight / 2.f, Color.GRAY);

                    }
                    //此处写死了值的颜色为黑色，覆盖了之前的颜色(值颜色与线条颜色相同时注释此行代码即可)
                    drawValue(c, formatter, value, entry, 0, labelPtx, labelPty, Color.BLACK);
                ...
                if (drawXInside || drawYInside) {
                    ...
                    if (drawXInside && drawYInside) {
                        ...
                        drawValue(c, formatter, value, entry, 0, x, y, Color.GRAY);
                        ...
                        drawValue(c, formatter, value, entry, 0, x, y + lineHeight / 2f, Color.GRAY);
                    }
                }
