package com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout;
...
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.decorator.IDecorator;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.decorator.OverScrollDecorator;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.decorator.RefreshProcessor;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.footer.IBottomView;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.footer.LoadMoreFootView;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.header.IHeaderView;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.header.LoadFreshHeaderView;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.header.OnAnimEndListener;
import com.chenganrt.smartSupervision.widget.TwinklingRefreshLayout.processor.AnimProcessor;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxHeadHeight = DimenUtil.dp2px(context, 120);
        mHeadHeight = DimenUtil.dp2px(context, 56);
        mMaxBottomHeight = DimenUtil.dp2px(context, 120);
        mBottomHeight = DimenUtil.dp2px(context, 56);
        mOverScrollHeight = (int) mHeadHeight;
        enableRefresh = true;
        enableLoadmore = true;
        ...
        if (mHeadView == null) {
            if (!TextUtils.isEmpty(HEADER_CLASS_NAME)) {
                try {
                    ...
                    setHeaderView(new LoadFreshHeaderView(getContext()));
                }
            } else {
                setHeaderView(new LoadFreshHeaderView(getContext()));
            }
        ...
        if (mBottomView == null) {
            if (!TextUtils.isEmpty(FOOTER_CLASS_NAME)) {
                try {
                    ...
                    setBottomView(new LoadMoreFootView(getContext()));
                }
            } else {
                setBottomView(new LoadMoreFootView(getContext()));
            }
     ...
     * 结束刷新
     */
    public void finishRefreshing(boolean isRefreshSuccess) {
        cp.finishRefreshing(isRefreshSuccess);
    }
    ...
    public void setMaxHeadHeight(float maxHeightDp) {
        this.mMaxHeadHeight = DimenUtil.dp2px(getContext(), maxHeightDp);
    }
    ...
    public void setHeaderHeight(float headHeightDp) {
        this.mHeadHeight = DimenUtil.dp2px(getContext(), headHeightDp);
    }

    public void setMaxBottomHeight(float maxBottomHeight) {
        mMaxBottomHeight = DimenUtil.dp2px(getContext(), maxBottomHeight);
    }
    ...
    public void setBottomHeight(float bottomHeightDp) {
        this.mBottomHeight = DimenUtil.dp2px(getContext(), bottomHeightDp);
    }
    ...
    public void setOverScrollHeight(float overScrollHeightDp) {
        this.mOverScrollHeight = DimenUtil.dp2px(getContext(), overScrollHeightDp);
    }
    ...
    @Override
    public void onFinishRefresh(boolean isRefreshSuccess) {
        if (refreshListener != null) {
            refreshListener.onFinishRefresh(isRefreshSuccess);
        }
    ...
    public class CoContext {
        ...
        public void finishRefreshing(boolean isRefreshSuccess) {
            onFinishRefresh(isRefreshSuccess);
        }
        ...
        public void onFinishRefresh(boolean isRefreshSuccess) {
            pullListener.onFinishRefresh(isRefreshSuccess);
        }
