...
public class HomeFragment extends Fragment implements OnClickListener, OnRefreshListener {
    ...
    private void initRecentlyData() {
        ...
        Map<String, String> map = new HashMap<>();
        map.put("userId", UserSP.getInstance().getUserId(getActivity()));
        OkhttpUtil.okHttpGet(getActivity(), url, map, new CallBackUtil.CallBackString() {
            @Override
            public void onFailure(Call call, Exception e) {
                //Toast.makeText(HomeActivity.this, "服务器错误", Toast.LENGTH_SHORT).show();
...
//					mIntList.add(3000);
    ...
    private void initView(View view) {
        ...
        iv_messag = (ImageView) view.findViewById(R.id.iv_message);
        iv_messag.setOnClickListener(this);
        tv_more = (TextView) view.findViewById(R.id.tv_more);
        tv_more.setOnClickListener(this);
        tv_number = (TextView) view.findViewById(R.id.tv_number);
        view_message_num = (View) view.findViewById(R.id.view_message_num);

        bannerLayout = (BannerLayout) view.findViewById(R.id.banner);
        mTabLayout = (CommonTabLayout) view.findViewById(R.id.commontablayout);
        ...
        if (homeCoverBean != null) {
            ...
            bannerLayout.setOnBannerItemClickListener(new BannerLayout.OnBannerItemClickListener() {
                ...
                public void onItemClick(int position) {
                    WebViewActivity.start(getActivity(), urls_link.get(position));
                }
            });
        }
    }
...
//            mTabLayout.setCurrentTab(1);
            mTabLayout.setTabDataFragment(mTabEntities, this, R.id.fl_change, mFragments,mTabLayout.getCurrentTab());
        } else if (mFragments.size() == 1) {
            mTabLayout.setTabDataFragment(mTabEntities, this, R.id.fl_change, mFragments);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_message:
                Intent intent = new Intent(getActivity(), MatchingMessageActivity.class);
                startActivity(intent);
                break;
            case R.id.tv_more:
                WebViewActivity.start(getActivity(), "http://zjj.sz.gov.cn/xxgk/tzgg/index.html");
                break;
        }
    }
