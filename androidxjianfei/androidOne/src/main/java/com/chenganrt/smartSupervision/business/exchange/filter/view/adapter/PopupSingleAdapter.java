package com.chenganrt.smartSupervision.business.exchange.filter.view.adapter;
...
public class PopupSingleAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (bean.getSelecteStatus() == 0) {
            ...
            viewHolder.iv_accept.setVisibility(View.INVISIBLE);
            ...
            viewHolder.iv_accept.setVisibility(View.VISIBLE);
