...
public class WheelView extends View {
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        viewAdapter.setCurrentItem(index);
    ...
    private void doScroll(int delta) {
        ...
        if (pos != currentItem) {
            int old = currentItem - firstItem;
            setCurrentItem(pos, false);
            int current = currentItem - firstItem;
            if (itemsLayout != null && !isCyclic && viewAdapter instanceof AbstractWheelTextAdapter) {
                AbstractWheelTextAdapter mAdapter = (AbstractWheelTextAdapter) viewAdapter;
                View oldView = itemsLayout.getChildAt(old);
                View currentView = itemsLayout.getChildAt(current);
                if (oldView != null && oldView instanceof TextView &&
                        currentView != null && currentView instanceof TextView) {
                    mAdapter.configureTextView((TextView) oldView);
                    mAdapter.configureCurrentTextView((TextView) currentView);
                }
            }
        } else {
            invalidate();
