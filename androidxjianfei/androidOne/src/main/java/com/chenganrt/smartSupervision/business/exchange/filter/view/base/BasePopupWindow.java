package com.chenganrt.smartSupervision.business.exchange.filter.view.base;
...
public abstract class BasePopupWindow extends PopupWindow {
    ...
    public BasePopupWindow(Context context, List data, int filterType, int position, OnFilterToViewListener onFilterToViewListener) {
        ...
        mFrameLayout.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
