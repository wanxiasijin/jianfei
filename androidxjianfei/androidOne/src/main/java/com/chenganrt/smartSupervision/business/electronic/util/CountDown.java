...
public class CountDown implements ICountDownTime {
    ...
    * */
    public CountDown(int beatTime, boolean changeable) {
        BEAT_TIME = beatTime;
    ...
    @Override
    public void removieObserver(Observer observer) {
        if (weakHashMap.containsKey(observer)) weakHashMap.remove(observer);
    }
